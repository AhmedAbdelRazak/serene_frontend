...
const ZReturnAndExchange = () => {
	...
	return (
		<ZReturnAndExchangeWrapper>
			<div className='form-group'>
				<label className='text-muted'>Return And Refund Policy</label>
				<ReactQuill
					value={returnsAndExchange}
					onChange={setReturnsAndExchange}
					modules={{
...
export default ZReturnAndExchange;

const ZReturnAndExchangeWrapper = styled.div`
	min-height: 700px;
